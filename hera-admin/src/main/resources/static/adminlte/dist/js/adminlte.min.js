...
if ("undefined" == typeof jQuery) throw new Error("AdminLTE requires jQuery"); + function(a) {
    ...
    g.prototype.activate = function() {
        ...
        return a("body").hasClass(f.fixed) ? void(this.options.slimscroll && "undefined" != typeof a.fn.slimScroll && (a(e.sidebar).slimScroll({
            destroy: !0
        }).height("auto"), a(e.sidebar).slimScroll({
            height: a(window).height() - a(e.mainHeader).height() + "px",
            color: "rgba(0,0,0,0.2)",
            size: "3px"
        }))) : void("undefined" != typeof a.fn.slimScroll && a(e.sidebar).slimScroll({
            destroy: !0
        }).height("auto"))
    };
    var h = a.fn.layout;
    ...
    h.prototype.init = function() {
        ...
        var b = a(window).width();
        b > this.options.collapseScreenSize ? a("body").addClass(f.collapsed).trigger(a.Event(g.collapsed)) : a("body").removeClass(f.open + " " + f.collapsed).trigger(a.Event(g.collapsed))
    ...
    h.prototype.toggle = function() {
        ...
        a(this.element).removeClass(f.collapsed), a(e.tools).find("." + d).removeClass(d).addClass(c), a(this.element).find(e.body + ", " + e.footer).slideDown(this.options.animationSpeed, function() {
        ...
        var b = a.Event(g.collapsed),
            c = this.options.collapseIcon,
            d = this.options.expandIcon;
        a(e.tools).find("." + c).removeClass(c).addClass(d), a(this.element).find(e.body + ", " + e.footer).slideUp(this.options.animationSpeed, function() {
