layui.use("layer", function () {
    ...
    registerForm.validate({
        ...
        submitHandler: function () {
            $.post($("#baseURl").attr("href") + "/admin/register", {
                name: $('#name').val(),
    ...
    $("#loginForm").validate({
        ...
        submitHandler: function () {
            $.post($("#baseURl").attr("href") + "/admin/login", $("#loginForm").serialize(), function (data) {
                layer.msg(data.message);
                if (data.success === true) {
                    localStorage.setItem("ssoName", "管理员:" + $("#loginForm [name='userName']").val());
