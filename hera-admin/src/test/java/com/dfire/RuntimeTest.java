 ...
 * @time: Created in 11:18 2018/3/23
 * @desc
 */
public class RuntimeTest {
    ...
    public void getSystemPath() {
        System.out.println(RuntimeTest.class.getResource("/").getPath());
    ...
    public void memory() throws SigarException {
        System.setProperty( "java.library.path", RuntimeTest.class.getResource("").getPath());
